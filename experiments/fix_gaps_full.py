#!/usr/bin/env python3
"""
Backfill daily ECB data from Dec 1, 2025 onward.
This fills in all business days in the transition zone from weekly to daily data.
"""
...
def main():
    ...
    # Fetch daily data from Dec 1 through Dec 21, 2025
    # (Dec 22 onward is already backfilled)
    print("Fetching daily data for 2025-12-01..2025-12-21...")
    ...
    for from_curr, to_curr in FRANKFURTER_PAIRS:
        ...
        url = f"https://api.frankfurter.dev/v1/2025-12-01..2025-12-21?from={from_curr}&to={to_curr}"
        try:
            data = fetch_json(url)
