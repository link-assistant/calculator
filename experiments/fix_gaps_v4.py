#!/usr/bin/env python3
"""Backfill ECB data for Dec 22-28, 2025 (Christmas week gap) to complete the transition."""
...
def main():
    ...
    print("Fetching daily data for 2025-12-22..2025-12-28 (Christmas week)...")
    ...
    for from_curr, to_curr in FRANKFURTER_PAIRS:
        ...
        url = f"https://api.frankfurter.dev/v1/2025-12-22..2025-12-28?from={from_curr}&to={to_curr}"
        try:
            data = fetch_json(url)
