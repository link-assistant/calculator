...
### Added
- Enhanced display format for time expressions like "UTC time", "current UTC time", "EST time": now shows as `'current UTC time': 2026-03-02 20:40:13 (+00:00)` with timezone label and offset
